...
import { DETECTIVE_QUESTIONS, DetectiveQuestion } from '../../../data/minigamesData';
...
export const MathDetectiveGame: React.FC<MathDetectiveGameProps> = ({
  ...
  const activeCase = currentCase || DETECTIVE_QUESTIONS[detectiveIndex] || DETECTIVE_QUESTIONS[0];
  const total = totalCases ?? DETECTIVE_QUESTIONS.length;
      ...
      <div className="p-6 sm:p-8 lg:p-10 rounded-2xl bg-[#14161a] border border-zinc-800 shadow-xl space-y-8">
        <div>
          <span className="text-xs font-mono font-bold text-rose-400">
            Detective Matemático • Caso {detectiveIndex + 1} de {total}
          </span>
        ...
        {selectedFlawedStep !== null && (
          <div className="flex justify-end pt-4 border-t border-zinc-800">
            ...
            >
              <span>{detectiveIndex + 1 < total ? 'Siguiente Caso' : 'Finalizar Detective'}</span>
